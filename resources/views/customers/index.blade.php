            ...
            <div id="customerCars" class="input-group">
                ...
                @can('customer-edit')
                    ...
                    <div class="input-group visually-hidden">
                        ...
                        <input class="form-control" name="state[]" type="text"  value="" pattern="[АВЕКМНОРСТУХ]{1}[0-9]{3}[АВЕКМНОРСТУХ]{2}[0-9]{2-3}" placeholder="Госномер">
                ...
                <div class="input-group">
                    ...
                    @can('customer-edit')
                        ...
                        <div class="input-group visually-hidden">
                            ...
                            <input class="form-control" name="state[]" type="text"  value="{{$car->state_number}}" pattern="[АВЕКМНОРСТУХ]{1}[0-9]{3}[АВЕКМНОРСТУХ]{2}[0-9]{2-3}" placeholder="Госномер">
                            {{Form::submit('&#10003;',array('class'=>'input-group-text btn btn-primary model'))}}
                        </div>
                    @endcan
                </div>
