...
<table class="table table-bordered table-hover">
    ...
    <tr id="create">
        ...
        <td>
            <input class="form-control" name="state" type="text" pattern="[АВЕКМНОРСТУХ]{1}[0-9]{3}[АВЕКМНОРСТУХ]{2}[0-9]{2-3}" placeholder="Введите гос номер (С189АН78)" required>
        </td>
        <td>
    ...
    <tr>
        ...
        <td><span>{{ $car->state_number }}</span>
            ...
            <div class="input-group visually-hidden">
                <input class="form-control" name="state" type="text"  value="{{ $car->state_number }}" pattern="[АВЕКМНОРСТУХ]{1}[0-9]{3}[АВЕКМНОРСТУХ]{2}[0-9]{2-3}">
                {{Form::submit('&#10003;',array('class'=>'input-group-text btn btn-primary'))}}
            </div>
            @endcan</td>
        <td class="btns">
